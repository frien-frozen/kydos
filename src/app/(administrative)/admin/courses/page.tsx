...
import { getCourses, toggleCoursePublish, createCourse } from "@/app/actions/courses";
import Link from "next/link";

export default async function AdminCoursesDashboard() {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          {courses.length === 0 ? (
            <div className="p-8 text-center text-gray-500 dark:text-gray-400">No courses globally available.</div>
          ) : (
